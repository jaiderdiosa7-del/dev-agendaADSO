...
function FormularioContacto({ onAgregar }) {
  ...
  function validarFormulario() {
    ...
    const nuevosErrores = { nombre: "", telefono: "", correo: "", empresa:"",etiqueta:""};
  ...
  return (
    <form
      className="border-white border  bg-gradient-to-br from-black via-blue-900 to-slate-950   shadow-sm rounded-2xl p-6 space-y-4 mb-8"
      onSubmit={onSubmit}
    >
      ...
      <div>
        ...
        <input
          className="w-full rounded-xl border border-gray-300 p-1 px-4 focus:ring-purple-500 focus:border-purple-500"
          name="nombre"
        ...
        {errores.nombre && (
          <p className="mt-1 text-l text-red-600">{errores.nombre}</p>
        )}
      </div>
      ...
      <div>
        ...
        <input
          className="w-full rounded-xl border border-gray-300 p-1 px-4 text-base focus:ring-purple-500 focus:border-purple-500"
          name="telefono"
        ...
        {errores.telefono && (
          <p className="mt-1 text-l text-red-600">{errores.telefono}</p>
        )}
      </div>
      ...
      <div>
        ...
        {errores.correo && (
          <p className=" mt-1 text-l text-red-600">{errores.correo}</p>
        )}
      </div>
      ...
      <div className="pt-2">
        <button
          ...
          disabled={enviando}
          className="w-full md:w-auto bg-purple-600 hover:bg-puwhite
